...
public class AwsCognitoJwtAuthFilter extends OncePerRequestFilter {
    ...
    private final OpenServiceIgnoringMatchers openServiceIgnoringMatchers;
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            log.error(
                    "[Marketplace Open Service] Cognito Id Token processing error, {}",
                    e.getMessage());
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        for (AntPathRequestMatcher matcher : openServiceIgnoringMatchers.getIgnoringMatchers()) {
